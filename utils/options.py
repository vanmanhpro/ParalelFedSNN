...
def args_parser():
    ...
    parser.add_argument('--checkpoint_every', type=int, default=10, help='Frequency of model checkpoint')
    ...
    parser.add_argument('--initial_cmp_rate', type=float, default=1.0, help="Initial compression rate")
    parser.add_argument('--final_cmp_rate', type=float, default=0.01, help="Final compression rate")
    parser.add_argument('--cmp_rate_decrease', type=str, default=None, help="Mode of compresison decreasing")
    parser.add_argument('--cycle_cmp_rate', type=int, default=None, help="Reducing cycle")
    parser.add_argument('--loss_diff_tolerance', type=float, default=None, help="The loss difference between server-client before reset cmp_rate")
